...
## MSL and DXIL blobs, so it runs on Vulkan, Metal and Direct3D 12 alike. ESC
## quits.
...
const plasmaDxil = staticRead("plasma.dxil")
...
let plasma = n2d.newShader(plasmaSpv, plasmaMsl, plasmaDxil, uniformFloats = 4)
var t = 0.0
